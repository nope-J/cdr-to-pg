...
/**
 * Created by nope-J on 2016/10/11.
 */

public class WriteCdr implements Runnable {
    ...
    public WriteCdr(String fileName,IService cdrBaseService, IService successRecordBaseService, IService failRecordBaseService){
...
//                dis.read(byte10);
            ...
            successRecord.setFileName(fileName);
            ...
            failRecord.setFileName(fileName);
